/*
 [10:49] Jose Miguel Delgado Bejarano
...
public class ReservaVuelo5Controller implements Initializable {
    ...
    public static double pTotal = ReservaVueloTarifaController.precioTotal+ VentanaReservasV4Controller.precioTotalRegreso;
    @FXML
    ...
    public void showTotal(){
        ...
        Label totalLabel = new Label("Precio total: "+ pTotal);
    ...
    private void continuee(){
        ...
        continuarBoton.setStyle("-fx-background-color: #661d1d; -fx-background-radius: 7;-fx-border-color: black;-fx-border-radius: 7;-fx-border-width: 2;");
